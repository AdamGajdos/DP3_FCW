classdef Berkeley_FCW_Algo < FCW_Algo
    ...
    methods(Static, Access = private)
        ...
        function nonDimValue = define_danger(velocity, relative_velocity, deceleration, distance, delay)
     ...
     methods(Static, Access = public)
        function situation_status = Resolve(velocity, relative_velocity, deceleration, distance, delay)
           
            non_dimensional_value = Berkeley_FCW_Algo.define_danger(velocity, relative_velocity, deceleration, distance, delay);
